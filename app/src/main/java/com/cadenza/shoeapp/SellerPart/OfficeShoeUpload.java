...
public class OfficeShoeUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference = db.getReference("Office_Shoe_items");
                ...
                Toast.makeText(OfficeShoeUpload.this,"Item Successfullt Enterd ",Toast.LENGTH_SHORT).show();
